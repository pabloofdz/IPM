...
const TYPE = "public";
const APP_ID = "e6cf0e17";
const APP_KEY = "22c8dc38605fc1a058a2192087d580bb";
...
class Nutrient {
  ...
  @override
  String toString() {
    return "\t\t$label: ${value.toStringAsFixed(2)} ${units[label]}\n";
  }
}
...
Future<RecipeBlock?> search_recipes(String query, String mealType, String cont) async {
  // TODO: include a search criteria!
  var formattedQuery = "";
  if(cont.isEmpty){
    formattedQuery = "type=$TYPE&beta=true&mealType=$mealType&app_id=$APP_ID&app_key=$APP_KEY&q=$query";
  }else {
    formattedQuery = "type=$TYPE&beta=true&mealType=$mealType&_cont=$cont&app_id=$APP_ID&app_key=$APP_KEY&q=$query";
  }
...
void main(List<String> arguments) async {
  if (arguments.isEmpty) {
    ...
    try {
      var block = await search_recipes(arguments[0], arguments[1], arguments[2]);
      print(block);
    } catch (exception) {
      print(exception);
    }
